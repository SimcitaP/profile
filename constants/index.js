...
const services = [
  ...
  { title: "Mobile Developer", icon: backend },
];

const aws        = 'https://cdn.simpleicons.org/amazonaws/FF9900';
const supabase   = 'https://cdn.simpleicons.org/supabase/3ECF8E';
const render     = 'https://cdn.simpleicons.org/render/46E3B7';
const railway    = 'https://cdn.simpleicons.org/railway/ffffff';
const openai     = 'https://cdn.simpleicons.org/openai/ffffff';
const postgresql = 'https://cdn.simpleicons.org/postgresql/4169E1';
const python     = 'https://cdn.simpleicons.org/python/3776AB';
...
const testimonials = [
  ...
  {
    testimonial: "I have had the opportunity to work with Sima in many projects in university, his desire to constantly learn even under pressure is something I admire about him, he has great communication skills and knows when to ask for help. Overall he's a fantastic team player and a great friend too",
...
const projects = [
  {
    id: "learnledger",
    name: "Learnledger",
    description: "Web-based school management system that allows uploading of lessons, assignments and exams that both students and parents can see at any time allowing parent to stay up to date with their children's learning material and progress.",
  ...
  },
  {
    ...
    description: "This is a fully backend-only project that focuses on managing subscriptions for any software that may need it. It includes authentication, authorization and subscription management using ExpressJS and MongoDB.",
  ...
  },
  {
    ...
    description: "A collaborative platform designed for students, researchers, and institutions to connect, share ideas, and work together on research projects. Supports project creation, team collaboration, document sharing, and role-based access.",
  ...
  },
  {
    id: "hoopmania",
    name: "HoopMania",
    description: "A modern basketball statistics tracking platform with real-time and historical player and team performance analytics, interactive dashboards, and predictive analytics.",
  ...
  },
  {
    id: "spendly",
    name: "Spendly",
    description: "An intelligent financial habits tracking application that leverages AI to analyze spending patterns, predict future habits, and recommend smarter financial decisions.",
  ...
  },
  {
    id: "seider-theatre",
    name: "Seider theatre",
    description: "A React Native app for web, Android, and iOS for streaming the latest movies with an algorithm for finding trending movies everyone is looking forward to watching.",
