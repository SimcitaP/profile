...
const ProjectDetails = () => {
  ...
  if (!project) {
    return (
      <div className="relative z-0 bg-primary min-h-screen flex flex-col justify-center items-center text-center p-6">
        <h2 className="text-white text-3xl font-extrabold mb-4 font-poppins">Project Not Found</h2>
        <button
          onClick={() => navigate("/")}
  ...
  return (
    <div className="relative z-0 bg-primary min-h-screen overflow-x-hidden font-poppins pb-24">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-32 sm:pt-36">
        {/* Back navigation */}
        <motion.button
        ...
        >
          {/* Left Column: Tech Stack & Methodology */}
          ...
          {/* Right Column: Problem and Solution details */}
          <div className="md:col-span-8 space-y-8">
            ...
            <div className="bg-[#100d25]/40 border border-secondary/10 p-8 rounded-2xl backdrop-blur-md space-y-4">
              ...
              <p className="text-secondary leading-relaxed text-[16px] font-light">
                {project.problem}
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#151030]/80 to-[#100d25]/80 border border-[#915eff]/30 p-8 rounded-2xl backdrop-blur-md space-y-4 shadow-lg shadow-purple-500/5">
              ...
              <p className="text-[#dfd9ff] leading-relaxed text-[16px] font-light">
                {project.solution}
              </p>
            </div>
          </div>
